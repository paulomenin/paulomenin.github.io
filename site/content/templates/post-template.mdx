...
This template has all frontmatter fields to use as an example to create new posts.
...
- slide_url: only useful for slide-deck post

Add Kroki diagrams:

<Kroki files={props.krokiFiles} src="file.kroki" />
