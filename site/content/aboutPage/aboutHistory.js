...
function AboutMyHistory() {
  return (
    <>
      <p className="mt-0">
        My history with computers began a long time ago when I was a child at 9
        years old. I remember watching movies with people using computers and
        started playing with boxes imagining that I&apos;m using computers. I
        asked my parents to learn how to use it. My parents tried to enroll me
        in a computer school, but they didn&apos;t accept me because I was too
        young.
      </p>
      <p>
        Some years later, another school accepted me as a student for a basic
        course: MS-DOS, Windows 95, and Microsoft Office. I was the youngest
        student in the class. My interest in computers only grew. When I
        finished the basic course I was enrolled in a advanced course:
        Introduction to programming with Visual Basic and Borland Delphi.
      </p>
      <p>
      ...
      <p>
        ...
        it! It came with a minimal version of the Slackware Linux (ZipSlack). It
        took me a lot of days to install it and configure X with Window Maker.
        That episode was a turning point in my life. That was the first
        challenge that I remember that I did on my own without help from anyone
        else, I didn&apos;t known anybody who has been using Linux. Learning
        Linux exploring man pages and reading internet articles in English (at
        that time understanding English was challenging for me) opened my mind
        to have confidence that I can learn anything that I want!
      </p>
      <p>
        In 2002 I enrolled in a Computer Technician course, where I have contact
      ...
      <p>
        ...
        <Link href="https://www.icmc.usp.br/en/">ICMC-USP</Link> BCS course,
        which is among the best ranked in Brazil. During the undergraduate
        course, I always seek to participate in extracurricular activities. I
        was a volunteer in a project that teaches how to use computers to people
        that can&apos;t afford to pay for a course. I joined &quot;Sanca
      ...
      <p className="mb-0 italic">That&apos;s me, every day moving forward!</p>
    </>
  )
}
